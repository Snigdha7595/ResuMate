    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-center justify-center xl:-mt-10">
        ...
        >
          ...
          >
            <div
              className={`p-6 group-hover:bg-indigo-100 border border-transparent group-hover:border-indigo-300  flex gap-4 rounded-xl transition-colors ${
                !isHover ? "border-indigo-300 bg-indigo-100" : ""
              }`}
            >
              <svg
